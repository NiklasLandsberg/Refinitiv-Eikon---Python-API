...
The loops might break but ek.set_timeout(10000) should circumvene it. If it breaks, then the loop has to be rerun. It is a known problem in the Python API. (# https://community.developers.refinitiv.com/questions/45723/why-eikonerror-error-code-400-backend-error-400-ba.html)
